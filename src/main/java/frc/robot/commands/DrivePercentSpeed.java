...
public class DrivePercentSpeed extends Command {
  ...
  /**
   * Drives the robot straight at a fixed speed and stops after it travels a specified distance (or
   * is canceled). Waits 1 second to align wheel facings prior to starting robot movement.
   *
   ...
   * @param percentSpeed robot percent voltage, from -1 to +1 (positive = in direction of
   *     angleFacing, negative = opposite direction)
   * @param maxDistance maximum distance for the robot to travel before ending this command, in
   *     meters
   * @param driveTrain DriveTrain subsystem
   */
  public DrivePercentSpeed(
      double angleFacing, double percentSpeed, double maxDistance, DriveTrain driveTrain) {
  ...
  /**
   * Drives the robot straight at a fixed speed and stops after it travels a specified distance (or
   * is cancelled). Waits 1 second to align wheel facings prior to starting robot movement.
  ...
  public void initialize() {
    ...
    DataLogUtil.writeMessage(
        "DrivePercentSpeed: Init, Angle Facing Desired =",
        angleFacing,
        ", Percent Speed Deisred =",
        percentSpeed,
        ", Max Distance =",
        maxDistance);
  }
