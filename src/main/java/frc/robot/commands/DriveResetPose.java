...
public class DriveResetPose extends Command {
   ...
   * @param curXinMeters Robot X location in the field, in meters (0 = field edge in front of the Blue driver station, +=away from the Blue drivestation)
   * @param curYinMeters Robot Y location in the field, in meters (0 = right edge of field when standing in the Blue driver station, +=left when looking from the Blue drivestation)
   * @param curAngleinDegrees Robot angle on the field, in degrees (0 = facing away from the Blue drivestation, + to the left, - to the right)
