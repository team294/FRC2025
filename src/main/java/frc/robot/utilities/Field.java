...
public class Field {
   ...
   * @param log FileLog utility
    ...
    public Field(AllianceSelection allianceSelection){
        ...
        reefScoringPositionsByAprilTagL1.put(ReefLocation.D, aprilTagFieldLayout.getTagPose(17).get().toPose2d().rotateAround(aprilTagFieldLayout.getTagPose(17).get().toPose2d().getTranslation(), new Rotation2d(Math.PI)).transformBy(new Transform2d(0, -FieldConstants.ReefScoringPositionAprilTagOffset, new Rotation2d(0))));
