...
public class AutoSelection {
	...
	public Command getAutoCommand(CommandXboxController xboxController, DriveTrain driveTrain, Elevator elevator, Wrist wrist, CoralEffector coralEffector, AlgaeGrabber algaeGrabber, Hopper hopper) {
		...
		if (autoPlan == RoutineSelectionOption.NONE.value) {
			...
			autonomousCommandMain = new AutoCoralCycleLoop(reefLocations, reefLevels, true, driveTrain, elevator, wrist, coralEffector, hopper, xboxController, rightJoystick, allianceSelection, field, log);
		}
