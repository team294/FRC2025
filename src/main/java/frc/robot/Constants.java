...
public final class Constants {
  ...
  public static final class CoralEffectorConstants {
    ...
    public static final double outtakePercent = 0.4;      // CALIBRATED - used for L1 and L4
  ...
  public static final class ElevatorWristConstants {
    public enum ElevatorWristPosition {
      ...
      CORAL_L1(13.0, 95.0),
      CORAL_L2(22.06, 95.0), // RECALIBRATED ON 4/7. was 65.0 degrees, adjusted to be 1 coral away from reef
      CORAL_L3(37.28, 95.0), // RECALIBRATED ON 4/7. was 65.0 degrees, adjusted to be 1 coral away from reef
      CORAL_L4(71.0, 57.0),
