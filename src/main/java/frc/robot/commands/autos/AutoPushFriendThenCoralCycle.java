  ...
  public AutoPushFriendThenCoralCycle(List<ReefLocation> reefLocations, List<ReefLevel> reefLevels, boolean endAtHP, boolean grabAlgae, DriveTrain driveTrain, 
    ...
    addCommands(
      ...
      either(
        ...
        new AutoCoralCycleLoop(reefLocations, reefLevels, endAtHP, driveTrain, elevator, wrist, coralEffector, hopper, xboxController, rightJoystick, alliance, field, log),
        () -> grabAlgae
      )
    );
  }
