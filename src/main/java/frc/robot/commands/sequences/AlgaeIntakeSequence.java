...
/**
 * Intakes algae by moving the wrist and elevator to the indicated intake position, and then running
 * the algaeGrabber until the algae is in the mechanism.
 *
    ...
    addCommands(
                ...
                sequence(
                    ...
                    parallel(
                        ...
                        either(
                            ...
                            none(),
                            () ->
                                position == ElevatorWristPosition.ALGAE_LOWER
                                    || position == ElevatorWristPosition.ALGAE_UPPER))),
        ...
        either(
            new WristElevatorSafeMove(
                ElevatorWristPosition.START_CONFIG, RegionType.STANDARD, elevator, wrist),
            none(),
            () ->
                position == ElevatorWristPosition.ALGAE_GROUND
                    || position == ElevatorWristPosition.ALGAE_LOLLIPOP),
