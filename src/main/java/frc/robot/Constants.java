...
public final class Constants {
  ...
  public static final class CoralEffectorConstants {
    ...
    public static final double centerRotationsUndershoot = 0.55;  // CALIBRATED #3  Measure the typical undershoot with kP.  This value (in motor rotataions) will be added to the encoder reading when the coral sensor is triggered.
