...
public class AutoCenterL4 extends SequentialCommandGroup {
  public AutoCenterL4(
    ...
    addCommands(
        ...
        new DriveToPose(
            CoordType.kRelative,
            new Pose2d(Units.inchesToMeters(20), 0, Rotation2d.kZero),
            driveTrain),
        ...
        // Drive forward to get to the reef (offset copied from DriveToReefWithOdometryForCoral,
        // plus 4 inches)
        new DriveToPose(
            CoordType.kRelative,
            () ->
        ...
        new DriveToPose(
            CoordType.kRelative,
            () -> new Pose2d(-DriveConstants.distanceFromReefToScore - 0.6, 0, new Rotation2d(0)),
            0.5,
            1.0,
            TrajectoryConstants.maxPositionErrorMeters,
            TrajectoryConstants.maxThetaErrorDegrees,
