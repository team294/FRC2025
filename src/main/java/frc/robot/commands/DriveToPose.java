...
public class DriveToPose extends Command {
   ...
   * @param goalPose target pose in Blue field coordinates.  Pose components include
   ...
   * Drives the robot to the desired pose in field coordinates.
   * Stops the robot at the end of the command, unless the command is interrupted.
   * @param goalPoseSupplier A function that supplies the target pose in Blue field coordinates.  Pose components include
   *    <p> Robot X location in the field, in meters (0 = field edge in front of the Blue driver station, +=away from the Blue drivestation)
   *    <p> Robot Y location in the field, in meters (0 = right edge of field when standing in the Blue driver station, +=left when looking from the Blue drivestation)
   *    <p> Robot angle on the field (0 = facing away from the Blue drivestation, + to the left, - to the right)
   ...
   * Stops the robot at the end of the command, unless the command is interrupted.
   * @param type CoordType, kRelative (turn relative to current robot angle) or kAbsolute (turn to Blue field angle)
