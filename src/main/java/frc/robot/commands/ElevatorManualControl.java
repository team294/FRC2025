...
public class ElevatorManualControl extends Command {
  ...
  /**
   * Controls the elevator and wrist using the Xbox controller joysticks
  ...
  public void initialize() {
    log.writeLog(false, "ElevatorManualControl", "Initialize");
  }
  ...
  public void execute() {
    ...
    elevPercent *= ElevatorConstants.maxPercentOutput;
