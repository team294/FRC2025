...
public class AutoSelection {
  ...
  public AutoSelection(
    ...
    // left-side trajectories are the right-side trajectories mirrored over the line going through
    ...
    //        Left side: A, L, K, J, I, H
    {
      ...
      reefToHPMap.put(
          ReefLocation.J,
          TrajectoryCache.mirrorVertically(
              trajectoryCache.getTrajectory(TrajectoryName.EToHP), "JToHP"));
      reefToHPMap.put(
          ReefLocation.K,
          TrajectoryCache.mirrorVertically(
              trajectoryCache.getTrajectory(TrajectoryName.DToHP), "KToHP"));
      reefToHPMap.put(
          ReefLocation.L,
          TrajectoryCache.mirrorVertically(
              trajectoryCache.getTrajectory(TrajectoryName.CToHP), "LToHP"));
      ...
      hpToReefMap.put(
          ReefLocation.J,
          TrajectoryCache.mirrorVertically(
              trajectoryCache.getTrajectory(TrajectoryName.HPToE), "HPToJ"));
      hpToReefMap.put(
          ReefLocation.K,
          TrajectoryCache.mirrorVertically(
              trajectoryCache.getTrajectory(TrajectoryName.HPToD), "HPToK"));
      hpToReefMap.put(
          ReefLocation.L,
          TrajectoryCache.mirrorVertically(
              trajectoryCache.getTrajectory(TrajectoryName.HPToC), "HPToL"));

      // Populate bargeToReefMap
      // bargeToReefMap.put(ReefLocation.A, null);
      // bargeToReefMap.put(ReefLocation.B, null);
      bargeToReefMap.put(
          ReefLocation.C, trajectoryCache.getTrajectory(TrajectoryName.BargeRightToC));
      bargeToReefMap.put(
          ReefLocation.D, trajectoryCache.getTrajectory(TrajectoryName.BargeRightToD));
      bargeToReefMap.put(
          ReefLocation.E, trajectoryCache.getTrajectory(TrajectoryName.BargeRightToE));
      // bargeToReefMap.put(ReefLocation.F, null);
      bargeToReefMap.put(
          ReefLocation.G, trajectoryCache.getTrajectory(TrajectoryName.BargeCenterToG));
      bargeToReefMap.put(
          ReefLocation.H,
          TrajectoryCache.mirrorVertically(
              trajectoryCache.getTrajectory(TrajectoryName.BargeCenterToG), "BargeCenterToH"));
      // bargeToReefMap.put(ReefLocation.I, null);
      bargeToReefMap.put(
          ReefLocation.J,
          TrajectoryCache.mirrorVertically(
              trajectoryCache.getTrajectory(TrajectoryName.BargeRightToE), "BargeRightToJ"));
      bargeToReefMap.put(
          ReefLocation.K,
          TrajectoryCache.mirrorVertically(
              trajectoryCache.getTrajectory(TrajectoryName.BargeRightToD), "BargeRightToK"));
      bargeToReefMap.put(
          ReefLocation.L,
          TrajectoryCache.mirrorVertically(
              trajectoryCache.getTrajectory(TrajectoryName.BargeRightToC), "BargeRightToL"));
    }

    // Auto selections
    autoRoutineChooser.setDefaultOption(
        RoutineSelectionOption.NONE.name, RoutineSelectionOption.NONE.value);
   ...
   * returned by getAutoCommand(). This method is designed to be called in advance of AutonomousInit
   * by Robot.java.
   */
  public void buildAutoCommand() {
    ...
    waitTime =
        MathUtil.clamp(
            waitTime, 0, 15); // make sure autoDelay isn't negative and is only active during auto
    ...
    if (autoPlan == RoutineSelectionOption.NONE.value) {
      ...
      autonomousCommandMain =
          new SequentialCommandGroup(
              new DriveResetPose(
                  allianceSelection.getAlliance() == Alliance.Red ? 0 : 180, false, driveTrain),
              new DriveToPose(
                  CoordType.kRelative, new Pose2d(1, 0, new Rotation2d(0)), driveTrain));
      ...
      autonomousCommandMain =
          new SequentialCommandGroup(
              new DriveResetPose(
                  allianceSelection.getAlliance() == Alliance.Red ? 0 : 180, false, driveTrain),
              new DriveToPose(
                  CoordType.kRelative, new Pose2d(2, 0, new Rotation2d(0)), driveTrain));
      ...
      List<ReefLocation> reefLocations =
          new ArrayList<>(Arrays.asList(ReefLocation.E, ReefLocation.D, ReefLocation.C));
      List<ReefLevel> reefLevels =
          new ArrayList<>(Arrays.asList(ReefLevel.L4, ReefLevel.L4, ReefLevel.L4));
      autonomousCommandMain =
      ...
      List<ReefLocation> reefLocations =
          new ArrayList<>(Arrays.asList(ReefLocation.J, ReefLocation.K, ReefLocation.L));
      List<ReefLevel> reefLevels =
          new ArrayList<>(Arrays.asList(ReefLevel.L4, ReefLevel.L4, ReefLevel.L4));
      autonomousCommandMain =
          new AutoCoralCycleLoop(
    ...
    // 	List<ReefLocation> reefLocations = new ArrayList<>(Arrays.asList(ReefLocation.E,
    // ReefLocation.D, ReefLocation.C));
    // 	List<ReefLevel> reefLevels = new ArrayList<>(Arrays.asList(ReefLevel.L2, ReefLevel.L4,
    // ReefLevel.L4));
    // 	autonomousCommandMain = new AutoCoralCycleLoop(reefLocations, reefLevels, false, true,
    // driveTrain, elevator, wrist, coralEffector, algaeGrabber, hopper, climber, rightJoystick,
    ...
    // 	List<ReefLocation> reefLocations = new ArrayList<>(Arrays.asList(ReefLocation.J,
    // ReefLocation.K, ReefLocation.L));
    // 	List<ReefLevel> reefLevels = new ArrayList<>(Arrays.asList(ReefLevel.L2, ReefLevel.L4,
    // ReefLevel.L4));
    // 	autonomousCommandMain = new AutoCoralCycleLoop(reefLocations, reefLevels, false, true,
    // driveTrain, elevator, wrist, coralEffector, algaeGrabber, hopper, climber, rightJoystick,
    ...
    // 	autonomousCommandMain = new AutoCoralCycleLoopThenAlgae(reefLocations, reefLevels, false,
    // driveTrain, elevator, wrist, coralEffector, algaeGrabber, hopper, led, rightJoystick,
    // allianceSelection, field);
    // }
    ...
    // }
      ...
      autonomousCommandMain =
          new AutoCenterL1(
              driveTrain, elevator, wrist, coralEffector, algaeGrabber, allianceSelection);
    ...
    // 	autonomousCommandMain = new DriveTrajectory(CoordType.kRelative, StopType.kBrake,
    // trajectoryCache.getTrajectory(TrajectoryName.Relative4mRotate180), driveTrain,
    // allianceSelection);
    // }
    ...
    // 	autonomousCommandMain = new DriveTrajectory(CoordType.kRelative, StopType.kBrake,
    // trajectoryCache.getTrajectory(TrajectoryName.RelativeArcLeft), driveTrain,
    // allianceSelection);
    // }
    ...
    // 	autonomousCommandMain = new DriveTrajectory(CoordType.kRelative, StopType.kBrake,
    // trajectoryCache.getTrajectory(TrajectoryName.RelativeStraight4m), driveTrain,
    // allianceSelection);
    // }
    ...
    // 	autonomousCommandMain = new DriveTrajectory(CoordType.kRelative, StopType.kBrake,
    // trajectoryCache.getTrajectory(TrajectoryName.RelativeCirclePath), driveTrain,
    // allianceSelection);
    // }
    ...
    // 	autonomousCommandMain = new DriveTrajectory(CoordType.kRelative, StopType.kBrake,
    // trajectoryCache.getTrajectory(TrajectoryName.RelativeRotate180), driveTrain,
    // allianceSelection);
    // }

    // else if (autoPlan == RoutineSelectionOption.AbsDiagonalTest.value) {
    // 	autoSelectionOption = RoutineSelectionOption.AbsDiagonalTest;
    // 	autonomousCommandMain = new DriveTrajectory(CoordType.kAbsolute, StopType.kBrake,
    // trajectoryCache.getTrajectory(TrajectoryName.AbsoluteDiagonalTest), driveTrain,
    // allianceSelection);
    // }
    ...
    // 								new
    // DriveResetPose(trajectoryCache.getTrajectory(TrajectoryName.BargeRightToE).getInitialPose(allianceSelection.getAlliance() == Alliance.Red).get(), true, driveTrain),
    // 								new DriveTrajectory(CoordType.kAbsolute, StopType.kBrake,
    // trajectoryCache.getTrajectory(TrajectoryName.BargeRightToE), driveTrain, allianceSelection)
    // 							);
    // }
    ...
    cachedAutonomousCommand =
        new SequentialCommandGroup(new WaitCommand(waitTime), autonomousCommandMain);

    String autoDescription =
        StringUtil.buildString(allianceSelection.getAlliance(), " ", autoSelectionOption);
    SmartDashboard.putString("Autonomous cached", autoDescription);
    DataLogUtil.writeMessage("AutoSelection: Built ", autoDescription);
  }

  /**
   * Gets the auto command based upon input from the shuffleboard. This method is designed to be
   * called at AutonomousInit by Robot.java.
   *
  ...
  /**
   * Schedules the auto command based upon input from the shuffleboard. This method is designed to
   * be placed on Shuffleboard, so that the user can run the currently-selected auto command.
   *
   * @return the command to run
   */
  ...
  public void periodic() {
    if (DataLogUtil.isMyLogRotation(logRotationKey)) {
      ...
      if ((newAutoPlan != autoPlan) || (newWaitTime != waitTime) || (newAlliance != alliance)) {
